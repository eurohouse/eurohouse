    ...
    if (sta=='bind') {
        ordered=Object.keys(obj).sort().reduce(
            ...
            if ((ordered[indi]!==undefined)||(indi!='')) {
                ...
                res+="<input type='button' onmouseover='soundButton();' style='width:35%;background:linear-gradient("+sysDefGradientLine.value+"deg, "+getUserData(indi,'fore_color')+" 0%, "+getUserData(indi,'arc_fore_color')+" 100%);' value='@"+indi+"' onclick='clip(&#34;"+indi+"&#34;);'>";
                res+="<input type='button' onmouseover='soundButton();' style='width:34%;background:linear-gradient("+sysDefGradientLine.value+"deg, "+getUserData(indi,'fore_color')+" 0%, "+getUserData(indi,'arc_fore_color')+" 100%);' value='"+af+"' onclick='clip(&#34;"+af+"&#34;);'>";
