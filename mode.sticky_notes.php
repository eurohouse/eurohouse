...
<input type="image" id="buttonKeyboard" onmouseover="soundButton();" class="power" onclick="soundClick(); myNotesRad.focus();" src="<?=$prefix[3].'keyboard.png';?>">
<input type="image" id="buttonBackspace" onmouseover="soundButton();" class="power" onclick="soundClick(); myNotesRad.value=''; countNote();" src="<?=$prefix[3].'backspace.png';?>"></p>
<p align='center' class='block'>
