<!-- note -->
<!-- AD: Notas adhesivas; AE: ورق ملاحظات; AG: Notas adhesivas; AR: Notas adhesivas; AT: Anmerkungen; BE: Remarques; BR: Lembretes; CH: Explorare Notae; CL: Notas adhesivas; CN: 便利贴; CO: Notas adhesivas; CU: Notas adhesivas; CY: Σημειώσεις; DD: Anmerkungen; DE: Anmerkungen; DR: Anmerkungen; ES: Notas adhesivas; FR: Remarques; GR: Σημειώσεις; IN: स्टिकी नोट; IQ: ورق ملاحظات; IR: ورق ملاحظات; IT: Note adesive; JP: ポストイット; KP: 부착 노트; KR: 부착 노트; KW: ورق ملاحظات; LK: चिपचिपा टिप्पणियाँ; MC: Remarques; MD: Note lipicioase; MX: Notas adhesivas; NP: སྦྱར་བའི་དྲན་ཐོ།; PT: Lembretes; QA: ورق ملاحظات; RO: Note lipicioase; RS: Напомене; RU: Заметки; SA: ورق ملاحظات; SM: Note adesive; SP: Explorare Notae; TR: Yapışkan notlar; UA: Замітки; VA: Explorare Notae -->
<?php if (isAuthorized()) { ?>
<script>
...
<p align='center' class='block'>
    <input type="image" class="power" id="buttonCipherLock" onmouseover="soundButton();" src="<?=$prefix[3].(($session['cipher']!=0)?'key.webp':'lock.webp');?>" onclick="soundClick(); setdata('cipher',flip(sysDefCipher.value));">
    <input class="text" id="myNotesRad" style="width:50%;" type="text" placeholder="<?=term('Symbolic Digits',$settings,$session);?>" value="<?=$session['numeric'];?>" onkeydown="if (event.keyCode==13) {
