...
function populateCommandIO() {
    if (requestMode.value==='terminal') {
        ...
        const row=tableBody.insertRow(); let cell=row.insertCell();
	let func='clip("'+promptExec.value+'");';
	let link=document.createElement('a');
	link.href='javascript:soundClick(); '+func;
	...
	link.href='javascript:soundClick(); '+func;
        link.textContent=result; link.style.cursor='pointer';
	cell.appendChild(link); promptExec.focus();
    }
}
