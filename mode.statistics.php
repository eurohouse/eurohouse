...
<div class='customPanel' style="width:100%;height:15%;left:0px;top:0px;">
    ...
    <input type="image" class="power" id="buttonSearch" onmouseover="soundButton();" src="<?=$prefix[3].'search.png';?>" onclick="populateIpStats(promptStats.value);"><input type="image" class="power" id="buttonBackspace" onmouseover="soundButton();" src="<?=$prefix[3].'backspace.png';?>" onclick="promptStats.value=''; promptStats.focus();">
    </p>
</div>
    ...
    <tr>
        <th style="width:20%;">
            <a href="javascript:SortTable(0,'T','','ipTable');">
                <?=term('Server Address',$settings,$session);?>
            </a>
        </th>
        <th style="width:20%;">
...
<tfoot id="ipFoot">
    <tr><th style="width:25%;" colspan="4">
