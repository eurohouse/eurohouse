...
<div class='customPanel' style="width:100%;height:15%;left:0px;top:0px;">
    ...
    <input type="image" class="power" id="buttonBackspace" onmouseover="soundButton();" src="<?=$prefix[3].'backspace.png';?>" onclick="soundClick(); promptExec.value=''; promptExec.focus();">
    </p>
</div>
