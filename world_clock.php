...
} else { $videoArr=["none","none","none","none","none","none"]; } $visitors=visitor($cookie);
echo /* ¶ 0 */ timedate(time(),$userData,$userSettings)."\r\n\r\n".
...
/* ¶ 5 */ $userData['pangram_'.(($userSettings['pangram'][$userData['units']])?$userSettings['pangram'][$userData['units']]:$userSettings['pangram']['default'])]."\r\n\r\n".
