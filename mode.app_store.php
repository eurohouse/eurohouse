...
<?php $line1Size=64; foreach ($settings['payload'] as $key=>$val) { ?>
<p align='center' class='block'>
    ...
    <?php foreach ($val as $ch) {
        ...
        <input type="button" name="<?=$ch;?>" value="<?=$ch;?>" style="width:<?=$line1Size;?>%;" onmouseover="soundButton();" onclick="clp(this.name);">
