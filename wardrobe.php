...
:root {
    ...
    --melody-marquee-animation: scrollMarquee <?=$session['melody_marquee_speed'].'s';?> linear infinite;
    ...
    --filter: none; --backdrop-filter: none; --backdrop-opacity: none;
...
.lowerGap {
    border: none; border-radius: 0px; position: relative;
    background-color: var(--qucolor); color: var(--backtextcolor);
    width: 100%; height: 1.6em; left: 0%; top: -5px;
    text-align: center; overflow: hidden;
}
.grid-container {
...
.melodyMarquee {
    overflow: hidden; white-space: nowrap; cursor: pointer;
    display: inline-block; animation: var(--melody-marquee-animation);
}
.panel {
    border: none; border-radius: 0px; position: relative;
    background-color: var(--qucolor); color: var(--backtextcolor);
    overflow-y: scroll; width: 100%; height: 54%; left: 0%; top: -2px;
}
.customPanel {
    border: none; border-radius: 0px; position: relative;
    background-color: var(--qucolor); color: var(--backtextcolor);
...
input.calcButton {
    background: var(--gradient-power); height: 1.4em; width: 1.4em;
}
input[type=checkbox] {
    background: var(--gradient-input); background-size: 100%;
