...
:root {
    ...
    --box-shadow: 0px 0px <?=$session['box_shadow'];?>px <?=$session['box_shadow'];?>px #<?=$session['blank_color'];?>;
    --text-box-shadow: 0px 0px <?=$session['box_shadow'];?>px <?=$session['box_shadow'];?>px #<?=$session['blank_text_color'];?>;
...
@font-face {
    ...
    unicode-range: U+0370-0385, U+03CF-03FF, U+0460-04FF, U+0780-10FF, U+1200-25FF, U+2700-2E7F, U+10000-1F2FF, U+1F650-1F67F, U+1F700-10FFFF;
}
@font-face {
    font-family: "euro";
...
input[type=text], input[type=password], input[type=number], select, textarea {
    ...
    position: relative; height: 1.4em; box-shadow: var(--text-box-shadow);
}
input[type=checkbox] {
