...
:root {
    ...
    --gradient-input: linear-gradient(180deg, var(--inputcolor) 0%, var(--arcinputcolor) 100%); --gradient-power: linear-gradient(var(--graddeg), var(--forecolor) 0%, var(--arcforecolor) 100%);
...
.upperGap {
    border: none; border-radius: 0px; position: relative;
    background-color: var(--bicolor); color: var(--backtextcolor);
    width: 100%; height: 1.5em; left: 0%; top: -2px;
