        ...
        <td>
            <p align='center' class='block'>
                <?php if ((is_dir($mediaFilename))&&(is_link($mediaFilename))) { ?>
                    ...
                    <input type="image" name="<?=$mediaFilename;?>" onmouseover="soundButton();" class="power" onclick="omniDir(this.name);" src="<?=$prefix[3].'directory.png';?>">
                <?php } else {
                    ...
                    <?php } else { ?>
                        <input type="image" name="<?=$mediaFilename;?>" onmouseover="soundButton();" class="power" onclick="omniPath(this.name,'','true');" src="<?=$prefix[3].'info.png';?>">
                        <input type="image" name="<?=$mediaFilename;?>" onmouseover="soundButton();" class="power" onclick="downloadFile(this.name,this.name);" src="<?=$prefix[3].'package.png';?>">
                    <?php }
                } ?>
            </p>
        </td>
