...
foreach ($index as $key=>$value) {
    ...
    <p align='center' class='block'>
        ...
        <?php
            ...
            <?php
            } elseif ((in_array($mediaFileExtension, duplex($settings['collections']['movie']))) || (in_array($mediaFileExtension, duplex($settings['collections']['video'])))) {
                ?>
