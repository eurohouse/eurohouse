...
<div class='topBarItem'>
    ...
    <input type="image" onmouseover="soundButton();" id="buttonUserStatus" class="power" onclick="omniAuthRequest('signout','','');" src="<?=$prefix.((isAuth())?'logout.png':'login.png');?>" title="<?=term('Sign Out',$settings['vocabulary'],$session['units']);?>">
