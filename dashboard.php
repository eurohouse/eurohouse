<div class='topBarItem'>
    ...
    <input type="image" onmouseover="soundButton();" id="buttonRandom" class="power" onclick="if (authstate()) { seekMusic(omniBox.value); } else { songIndex('random'); }" src="<?=$prefix[3].'music.png';?>" title="<?=term('Random Track',$settings,$session);?>">
