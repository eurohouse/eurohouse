...
<div class='topBarItem'>
    <p align='center' class='block'>
    <input type="image" onmouseover="soundButton();" id="buttonCode" class="power" onclick="soundClick(); var objCmdTxt=(authstate())?omniBox:omniBoxAuthLogin; seekCode(objCmdTxt.value);" src="<?=$prefix[3].'code.png';?>" title="<?=term('Random Code',$settings,$session);?>">
    <?php if (isAuthorized()) { ?>
