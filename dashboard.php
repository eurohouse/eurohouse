...
<div class='topBarItem'>
    ...
    <?php if (isAuthorized()) { ?>
        ...
        <input type='text' id="omniBox" style="width:58%;" placeholder="<?=term('Type command or expression and press ENTER',$settings,$session);?>" value="" onkeydown="if (event.keyCode==13) { omniEnter(this);
        ...
        <input type="image" onmouseover="soundButton();" id="buttonEnter" class="power" onclick="omniEnter(omniBox);" src="<?=$prefix[3].'return.png';?>" title="<?=term('Execute Command',$settings,$session);?>">
