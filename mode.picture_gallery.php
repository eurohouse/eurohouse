<!-- world -->
<!-- AD: Galería de Imágenes; AE: معرض الصور; AG: Galería de Imágenes; AT: Bildergalerie; BE: Galerie de Photos; BR: Galeria de Imagens; CH: Explorare Galleria; CL: Galería de Imágenes; CN: 图片库; CO: Galería de Imágenes; CU: Galería de Imágenes; CY: Συλλογή Εικόνων; DD: Bildergalerie; DE: Bildergalerie; DR: Bildergalerie; ES: Galería de Imágenes; FR: Galerie de Photos; GR: Συλλογή Εικόνων; IN: चित्र गैलरी; IQ: معرض الصور; IR: معرض الصور; IT: Galleria Fotografica; JP: 画像ギャラリー; KP: 화랑; KR: 화랑; KW: معرض الصور; LK: चित्रशाला; MC: Galerie de Photos; MD: Galerie de Imagini; MX: Galería de Imágenes; NP: པར་རིས་འགྲེམས་སྟོན།; PT: Galeria de Imagens; QA: معرض الصور; RO: Galerie de Imagini; RU: Картинная галерея; SA: معرض الصور; SM: Galleria Fotografica; SP: Explorare Galleria; TR: Resim Galerisi; UA: Картинна галерея; VA: Explorare Galleria -->
<!-- <ref> -->
<!-- true -->
<?php
...
if ($request['group']!='') {
    ...
    <tr>
        ...
        <td><p align='center' class='block'>
            ...
            <input type="image" name="<?=$key;?>" onmouseover="soundButton();" class="power" onclick="soundClick(); if (!isLocalhost()) { window.location.href='https://yandex.ru/images/search?rpt=imageview&url='+window.location.origin+'/'+this.name; }" src="<?=$prefix[3].'world.webp';?>">
