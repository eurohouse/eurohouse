...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='=';" value="=">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='!';" value="!">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='true';" value="⊤">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='false';" value="⊥">
<br>
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='*';" value="*">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='!=';" value="!=">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='E';" value="e">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='PI';" value="π">
<input type="image" class="power" onmouseover="soundButton();" style="width:40px;height:40px;top:14px;" onclick="calcExpr.value=''; calcExpr.focus();" src="<?=$prefix[3].'backspace.png';?>">
<br>
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='A';" value="A">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='B';" value="B">
<input type="image" class="power" onmouseover="soundButton();" style="width:40px;height:40px;top:14px;" onclick="calcExpr.focus();" src="<?=$prefix[3].'keyboard.png';?>">
<br>
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='C';" value="C">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;" onclick="calcExpr.value+='D';" value="D">
