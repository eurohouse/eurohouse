...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='A';" value="A">
</p>
<p align='center'>
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='%';" value="%">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='**';" value="**">
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+=')';" value=")">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='=';" value="=">
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='B';" value="B">
</p>
<p align='center'>
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='C';" value="C">
<br>
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='D';" value="D">
<br>
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='E';" value="E">
<br>
...
<input type="button" onmouseover="soundButton();" style="width:40px;height:40px;position:relative;" onclick="omniBox.value+='F';" value="F">
</p>
