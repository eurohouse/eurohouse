...
$showFilename=getback($userData);$variations=getways($showFilename,$userData);$brightAvaFore=((isColorLight($userData['fore_text_color']))?'ava.':'abc.');$brightAvaBack=((isColorLight($userData['back_text_color']))?'ava.':'abc.');
...
if (isset($cont[$showFilename])) {
    ...
    $showHead=localizedTitle($userData,'title');$showBody="";$showURLMaison="";
...
/* ¶ 6 */ ((isColorLight($userData['fore_text_color']))?'iso.':'iec.').";".((isColorLight($userData['fore_text_color']))?'rtd.':'rtc.').";".$brightAvaFore."\r\n\r\n".
/* ¶ 7 */ $showHead."\r\n\r\n".
/* ¶ 8 */ $showBody."\r\n\r\n".
/* ¶ 9 */ $personAvatar1."\r\n\r\n".
/* ¶ 10 */ $personAvatar2."\r\n\r\n".
