...
<div class='customPanel' id='prefs_tab' style="width:100%;height:70%;left:0px;top:0px;overflow-y:scroll;">
    <p align='center'>
        ...
        <input type="number" min='100' max='900' step='100' id="setMarqueeSpeed" style="width:26%;" placeholder="<?=term('Marquee Speed',$settings,$session);?>" value="<?=$session['marquee_speed'];?>" onkeydown="if (event.keyCode==27) { 
            this.value='500';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('marquee_speed',this.value); handleInput(this.value,true);">
        <input type="number" min='0' max='9' step='1' id="setMagnitude" style="width:26%;" placeholder="<?=term('Magnitude',$settings,$session);?>" value="<?=$session['magnitude'];?>" onkeydown="if (event.keyCode==27) {
            this.value=5;
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('magnitude',setMagnitude.value); handleInput(this.value,true);">
        <input type="number" min='18' max='26' step='2' id="setDispSize" style="width:26%;" placeholder="<?=term('Display Text Size',$settings,$session);?>" value="<?=$session['disp_size'];?>" onkeydown="if (event.keyCode==27) {
            this.value='18';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
