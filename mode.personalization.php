...
<div class='customPanel' id='pers_rtc' style="width:100%;height:80px;left:0px;top:0px;">
    <p align='center'>
        <img style="width:15%;" id="chooseReticle1" name="<?=$session['reticle_choice_1'];?>" onmouseover="soundButton();" src="<?=$reticlePrefix.$session['reticle_choice_1'].'.png';?>" onclick="setdata('reticle',chooseReticle1.name);">
        <img style="width:15%;" id="chooseReticle2" name="<?=$session['reticle_choice_2'];?>" onmouseover="soundButton();" src="<?=$reticlePrefix.$session['reticle_choice_2'].'.png';?>" onclick="setdata('reticle',chooseReticle2.name);">
        <img style="width:15%;" id="chooseReticle3" name="<?=$session['reticle_choice_3'];?>" onmouseover="soundButton();" src="<?=$reticlePrefix.$session['reticle_choice_3'].'.png';?>" onclick="setdata('reticle',chooseReticle3.name);">
        <img style="width:15%;" id="chooseReticle4" name="<?=$session['reticle_choice_4'];?>" onmouseover="soundButton();" src="<?=$reticlePrefix.$session['reticle_choice_4'].'.png';?>" onclick="setdata('reticle',chooseReticle4.name);">
        <img style="width:15%;" id="chooseReticle5" name="<?=$session['reticle_choice_5'];?>" onmouseover="soundButton();" src="<?=$reticlePrefix.$session['reticle_choice_5'].'.png';?>" onclick="setdata('reticle',chooseReticle5.name);">
    </p>
</div>
