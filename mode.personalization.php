...
<div class='customPanel' id='prefs_tab' style="width:100%;height:70%;left:0px;top:0px;overflow-y:scroll;">
    <p align='center'>
        ...
        <input type="number" min='100' max='900' step='100' id="setMarqueeSpeed" style="width:38%;" placeholder="<?=term('Marquee Speed',$settings,$session);?>" value="<?=$session['marquee_speed'];?>" onkeydown="if (event.keyCode==27) { 
            this.value='500';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('marquee_speed',this.value); handleInput(this.value,true);">
        <input type="number" min='100' max='900' step='100' id="setMelodyMarqueeSpeed" style="width:38%;" placeholder="<?=term('Melody Marquee Speed',$settings,$session);?>" value="<?=$session['melody_marquee_speed'];?>" onkeydown="if (event.keyCode==27) { 
            this.value='200';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('melody_marquee_speed',this.value); handleInput(this.value,true);">
	<br>
