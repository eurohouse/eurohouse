...
<div class='customPanel' id='pers_rtc' style="width:100%;height:80px;left:0px;top:0px;">
    <p align='center'>
        ...
        <img style="height:11%;" id="chooseReticle5" name="<?=$session['reticle_choice_5'];?>" onmouseover="soundButton();" src="<?=$reticlePrefix.$session['reticle_choice_5'].'.png';?>" onclick="setdata('reticle',chooseReticle5.name);">
    </p>
</div>
