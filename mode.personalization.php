...
<input type='image' id='prefsBtnApply' onmouseover="soundButton();" class="power" onclick="setdata('date_format', setDateFormat.value); setdata('time_format', setTimeFormat.value); setdata('active_hours', setActiveHours.value); setdata('currency', setCurrency.value);" src="<?=$prefix.'return.png';?>">
<input type='image' id='prefsBtnUpdate' onmouseover="soundButton();" class="power" onclick="setdata('units_list', setLanguages.value); setdata('menu', setMenuItems.value);" src="<?=$prefix.'lock.png';?>">
<input type='image' id='prefsBtnUpdateTitle' onmouseover="soundButton();" class="power" onclick="setdata('title', encodeURIComponent(setTitle.value)); setdata('codename', encodeURIComponent(setCodenameTitle.value)); setdata('project', encodeURIComponent(setProjectTitle.value));" src="<?=$prefix.'keyboard.png';?>">
<input type='image' id='prefsBtnUpdateTitles' onmouseover="soundButton();" class="power" onclick="setdata('titles', encodeURIComponent(setLocalizedTitles.value)); setdata('codenames', encodeURIComponent(setLocalizedCodenameTitles.value)); setdata('projects', encodeURIComponent(setLocalizedProjectTitles.value));" src="<?=$prefix.'movie.png';?>">
...
<input type='image' id='prefsBtnClear' onmouseover="soundButton();" class="power" onclick="setLanguages.value = 'EU,US'; setdata('units_list', setLanguages.value);" src="<?=$prefix.'error.png';?>"><br>
<label><?=term('Titles:',$settings['vocabulary'],$session['units']);?></label><br>
<input type="text" id="setTitle" style="width:25%;" value="<?=$session['title'];?>" placeholder="<?=term('Title',$settings['vocabulary'],$session['units']);?>" onkeydown="if (event.keyCode==13) { setdata('title',encodeURIComponent(this.value));
...
if (event.keyCode==13) { setdata('titles',this.value);
} else if (event.keyCode==27) {
...
if (event.keyCode==13) { setdata('codenames',this.value);
} else if (event.keyCode==27) {
...
if (event.keyCode==13) { setdata('projects',this.value);
} else if (event.keyCode==27) {
...
<input type="text" id="setDateFormat" style="width:25%;" value="<?=$session['date_format'];?>" placeholder="<?=term('Date Format',$settings['vocabulary'],$session['units']);?>" onkeydown="if (event.keyCode==13) { setdata('date_format',setDateFormat.value);
} else if (event.keyCode==27) {
    this.value='Y-m-d'; setdata('date_format','Y-m-d');
} else if (event.keyCode==8) { handleInput(this.value);
} else if (event.keyCode==46) { handleInput(this.value);
}" oninput="handleInput(this.value,true);">
<input type="text" id="setTimeFormat" style="width:25%;" value="<?=$session['time_format'];?>" placeholder="<?=term('Time Format',$settings['vocabulary'],$session['units']);?>" onkeydown="if (event.keyCode==13) { setdata('time_format',setTimeFormat.value);
} else if (event.keyCode==27) {
    this.value='H:i:s'; setdata('time_format','H:i:s');
} else if (event.keyCode==8) { handleInput(this.value);
} else if (event.keyCode==46) { handleInput(this.value);
}" oninput="handleInput(this.value,true);">
<input type="text" id="setLanguages" style="width:25%;" value="<?=$session['units_list'];?>" placeholder="<?=term('Localizations',$settings['vocabulary'],$session['units']);?>" onkeydown="if (event.keyCode==13) { setdata('units_list',setLanguages.value);
} else if (event.keyCode==27) {
...
<input type="text" id="setMenuItems" style="width:20%;" value="<?=$session['menu'];?>" placeholder="<?=term('Menu Items',$settings['vocabulary'],$session['units']);?>" onkeydown="if (event.keyCode==13) { setdata('menu',this.value);
} else if (event.keyCode==27) {
