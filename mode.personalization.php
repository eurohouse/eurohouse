...
<div class='customPanel' id='prefs_tab' style="width:100%;height:70%;left:0px;top:0px;overflow-y:scroll;">
    <p align='center'>
        ...
        <input type='image' onmouseover="soundButton();" class="power" onclick="setSpecimen.value='Q F S H Æ Ø Ð Ñ ʒ ʊ ʎ ɸ Σ Φ Ω Θ Г З Х Б خالد 인 방 학 적 中 网 あ オ რ Ֆ ט भो 🍷 ☕️ 🍾 🍫';" src="<?=$prefix[3].'backspace.png';?>" title="<?=term('Clear',$settings,$session);?>"></span><br>
