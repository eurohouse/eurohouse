...
<div class='customPanel' id='prefs_tab' style="width:100%;height:70%;left:0px;top:0px;overflow-y:scroll;">
    <p align='center'>
        ...
        <input type="number" min='100' max='900' step='100' id="setMarqueeSpeed" style="width:38%;" placeholder="<?=term('Marquee Speed',$settings,$session);?>" value="<?=$session['marquee'];?>" onkeydown="if (event.keyCode==27) { 
            this.value='500';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('marquee',this.value); handleInput(this.value,true);">
        <input type="number" min='100' max='900' step='100' id="setMediainfoSpeed" style="width:38%;" placeholder="<?=term('Mediainfo Speed',$settings,$session);?>" value="<?=$session['mediainfo'];?>" onkeydown="if (event.keyCode==27) { 
            this.value='200';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('mediainfo',this.value); handleInput(this.value,true);">
	<br>
        <input type="number" min='0' max='9' step='1' id="setMagnitude" style="width:38%;" placeholder="<?=term('Magnitude',$settings,$session);?>" value="<?=$session['magnitude'];?>" onkeydown="if (event.keyCode==27) {
            this.value=5;
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        ...
        <input type="number" min='16' max='20' step='2' id="setHead1Size" style="width:26%;" placeholder="<?=term('Heading Level 1 Size',$settings,$session);?>" value="<?=$session['head1_size'];?>" onkeydown="if (event.keyCode==27) {
            this.value='17';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('head1_size',this.value); handleInput(this.value,true);">
        <input type="number" min='16' max='20' step='2' id="setHead2Size" style="width:26%;" placeholder="<?=term('Heading Level 2 Size',$settings,$session);?>" value="<?=$session['head2_size'];?>" onkeydown="if (event.keyCode==27) {
            this.value='16';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
        }" oninput="setdata('head2_size',this.value); handleInput(this.value,true);">
        <input type="number" min='16' max='20' step='2' id="setHead3Size" style="width:26%;" placeholder="<?=term('Heading Level 3 Size',$settings,$session);?>" value="<?=$session['head3_size'];?>" onkeydown="if (event.keyCode==27) {
            this.value='15';
        } else if (event.keyCode==8) { handleInput(this.value);
        } else if (event.keyCode==46) { handleInput(this.value);
