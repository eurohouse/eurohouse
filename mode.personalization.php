<!-- speed -->
<!-- AD: Personalización; AG: Personalización; AT: Personalisierung; BE: Personnalisation; BR: Personalização; CH: Occasus Personalis; CL: Personalización; CN: 个性化和元数据; CO: Personalización; CU: Personalización; CY: Προσωπικότητα; DD: Personalisierung; DE: Personalisierung; DR: Personalisierung; ES: Personalización; FR: Personnalisation; GR: Προσωπικότητα; IN: वैयक्तिकरण; IT: Personalizzazione; JP: カスタマイズする; KP: 개인화하다; KR: 개인화하다; LK: व्यक्तिगतकरणम्; MC: Personnalisation; MD: Personalizare; MX: Personalización; NP: མི་སྒེར་ཅན་བཟོ་བ།; PT: Personalização; RO: Personalizare; RS: Персонализација; RU: Персонализация; SM: Personalizzazione; SP: Occasus Personalis; TR: Kişiselleştirme; UA: Персоналізація; VA: Occasus Personalis -->
