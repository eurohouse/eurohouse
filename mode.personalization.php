...
<input type='image' id='prefsBtnApply' onmouseover="soundButton();" class="power" onclick="setdata('date_format', setDateFormat.value); setdata('time_format', setTimeFormat.value); setdata('active_hours', setActiveHours.value);" src="<?=$prefix.'return.png';?>">
<input type='image' id='prefsBtnUpdate' onmouseover="soundButton();" class="power" onclick="setdata('units_list', setLanguages.value); setdata('menu', setMenuItems.value); window.location.reload();" src="<?=$prefix.'update.png';?>">
<input type='image' id='prefsBtnRename' onmouseover="soundButton();" class="power" onclick="setdata('title', encodeURIComponent(setTitle.value)); setdata('codename', encodeURIComponent(setCodenameTitle.value)); setdata('project', encodeURIComponent(setProjectTitle.value)); window.location.reload();" src="<?=$prefix.'new.png';?>">
<input type='image' id='prefsBtnRetitle' onmouseover="soundButton();" class="power" onclick="setdata('titles', encodeURIComponent(setLocalizedTitles.value)); setdata('codenames', encodeURIComponent(setLocalizedCodenameTitles.value)); setdata('projects', encodeURIComponent(setLocalizedProjectTitles.value)); window.location.reload();" src="<?=$prefix.'copy.png';?>">
