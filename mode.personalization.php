...
<input type="button" onmouseover="soundButton();" onclick="setdata('date_format', setDateFormat.value); setdata('time_format', setTimeFormat.value); setdata('title', encodeURIComponent(setTitle.value)); setdata('project', encodeURIComponent(setProjectTitle.value)); setdata('titles', encodeURIComponent(setLocalizedTitles.value)); setdata('projects', encodeURIComponent(setLocalizedProjectTitles.value));" value="<?=term('Apply', $settings['vocabulary'], $session['units']);?>">
