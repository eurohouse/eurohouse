...
<tbody><?php foreach ($exemplarArr as $key=>$value) {
    ...
    <tr>
        ...
        <?php } else { ?>
            <td><?php $bday=(isset($value['birthday']))?strtotime($value['birthday']):''; /*$bday=(isset($value['birthday']))?chooseCalendar(strtotime($value['birthday']),$session,$settings):'';*/ echo $bday; ?></td>
