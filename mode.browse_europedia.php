...
<tbody>
    ...
    <tr>
        ...
        <?php } else { ?>
            ...
            <td><?=(isset($value['sizes']))?((round((explode('-',$value['sizes'])[0]*$ssLC['length'][$ssUN]['coefficient']))).'-'.round((explode('-',$value['sizes'])[1]*$ssLC['length'][$ssUN]['coefficient'])).'-'.round((explode('-',$value['sizes'])[0]*$ssLC['length'][$ssUN]['coefficient']))):'';?></td>
