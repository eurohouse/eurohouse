...
<div class='customPanel' style="width:100%;height:60%;left:0px;top:0px;overflow-y:scroll;">
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('title',setTitle.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setTitle.value='';" title="<?=term('Reset',$settings,$session);?>"><br>
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('codename',setCodenameTitle.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setCodenameTitle.value='';" title="<?=term('Reset',$settings,$session);?>"><br>
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('project',setProjectTitle.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setProjectTitle.value='';" title="<?=term('Reset',$settings,$session);?>"></span><br>
        <label>
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('titles',setLocalizedTitles.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setLocalizedTitles.value='';" title="<?=term('Reset',$settings,$session);?>"><br>
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('codenames',setLocalizedCodenameTitles.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setLocalizedCodenameTitles.value='';" title="<?=term('Reset',$settings,$session);?>"><br>
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('projects',setLocalizedProjectTitles.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setLocalizedProjectTitles.value='';" title="<?=term('Reset',$settings,$session);?>"></span><br>
        <label>
            <?=term('Choose Your Avatar:',$settings,$session);?>
        </label><br>
        <span class='block'>
        <input id="showUserAvatarBadgeBottom" type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[1].$session['avatar'].'.png';?>" title="<?=term('User Avatar',$settings,$session);?>" onclick="soundClick(true);">
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('units_list',setLanguages.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setLanguages.value='';" title="<?=term('Reset',$settings,$session);?>"></span><br>
	...
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'return.png';?>" onclick="setdata('menu',setMenuItems.value);" title="<?=term('Update',$settings,$session);?>">
	<input type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].'backspace.png';?>" onclick="setMenuItems.value='';" title="<?=term('Reset',$settings,$session);?>"></span><br>
        <label><?=term('Signature Elements:',$settings,$session);?></label><br>
	<span class='block'>
	<input id="showUserTypeBadge" type='image' onmouseover="soundButton();" class="power" src="<?=$prefix[3].(($session['type']=='entity')?'home.png':'user.png');?>" title="<?=term('Update',$settings,$session);?>" onclick="soundClick(true);">
