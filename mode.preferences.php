...
<div class='customPanel' id='prefs_btns' style="width:100%;height:40px;left:0px;top:0px;">
    <p align='center'>
        ...
        <input type='image' id='prefsBtnReset' onmouseover="soundButton();" class="power" onclick="setSpecimen.value='Q F S H Æ Ø Ð Ñ ʒ ʊ ʎ ɸ Σ Φ Ω Θ Г З Х Б خالد 인 방 학 적 中 网 あ オ რ Ֆ ט भो 🍷 ☕️ 🍾 🍫'; setdata('specimen',setSpecimen.value);" src="<?=$prefix.'backspace.png';?>" title="<?=term('Reset Defaults',$settings['vocabulary'],$session['units']);?>">
        <input type='image' id='prefsBtnClear' onmouseover="soundButton();" class="power" onclick="setdata('font_ascii','flexo.ttf');setdata('font_latin','flexo.ttf');setdata('font_phone', 'arialuni.ttf');setdata('font_greek','ubuntu.ttf');setdata('font_cyril','ubuntu.ttf');setdata('font_arabi','arialuni.ttf');setdata('font_korea','arialuni.ttf');setdata('font_china','arialuni.ttf');setdata('font_other','arialuni.ttf');setdata('font_emoji','twemoji.ttf');" src="<?=$prefix.'error.png';?>" title="<?=term('Reset Default Fonts',$settings['vocabulary'],$session['units']);?>">
    </p>
</div>
<div class='customPanel' id='prefs_tab' style="width:100%;height:70%;left:0px;top:0px;overflow-y:scroll;">
    <p align='center'>
        ...
        <input type="text" id="setSpecimen" style="width:86%;" value="<?=$session['specimen'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <?php foreach ($userLocks['sound'] as $key=>$value) { ?>
            <option id="<?=$value;?>" <?php if (withReq($session['ticking_sound'])==$value) { ?> selected <?php } ?>><?=$value;?></option>
        <?php } ?></select>
        ...
        <?php foreach ($userLocks['sound'] as $key=>$value) { ?>
            <option id="<?=$value;?>" <?php if (withReq($session['background_sound'])==$value) { ?> selected <?php } ?>><?=$value;?></option>
        <?php } ?></select>
        ...
        <input type="text" id="setTextBoxShadow" style="width:27%;" value="<?=$session['text_box_shadow'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setTextShadow" style="width:27%;" value="<?=$session['text_shadow'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setBackSize" style="width:15%;" value="<?=$session['back_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setForeSize" style="width:15%;" value="<?=$session['fore_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setInputSize" style="width:15%;" value="<?=$session['input_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setGradDeg" style="width:15%;" value="<?=$session['gradient'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setHead2Size" style="width:15%;" value="<?=$session['head2_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setHead3Size" style="width:15%;" value="<?=$session['head3_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setDispSize" style="width:15%;" value="<?=$session['disp_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setForeColor" style="width:15%;" value="<?=$session['fore_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setInputColor" style="width:15%;" value="<?=$session['input_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setArcForeColor" style="width:15%;" value="<?=$session['arc_fore_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setArcInputColor" style="width:15%;" value="<?=$session['arc_input_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setBackTextColor" style="width:15%;" value="<?=$session['back_text_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setForeTextColor" style="width:15%;" value="<?=$session['fore_text_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setInputTextColor" style="width:15%;" value="<?=$session['input_text_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setBlankColor" style="width:15%;" value="<?=$session['blank_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setBlankTextColor" style="width:15%;" value="<?=$session['blank_text_color'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" placeholder="<?=term('Change your current username...', $settings['vocabulary'], $session['units']);?>" id="setUsername" style="width:42%;" value="<?=$sessionID;?>" onkeydown="
        if (event.keyCode==13) {
            setPassword.focus();
        } else if (event.keyCode==8) {
            handleInput(this.value);
        ...
        <input type="password" placeholder="<?=term('Set a password for your account...', $settings['vocabulary'], $session['units']);?>" id="setPassword" style="width:42%;" value="" onkeydown="
        if (event.keyCode==13) {
