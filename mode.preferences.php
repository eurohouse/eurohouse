...
<div class='customPanel' id='prefs_btns' style="width:100%;height:40px;left:0px;top:0px;">
    <p align='center'>
        <input type='image' id='prefsBtnApply' onmouseover="soundButton();" class="power" onclick="setdata('box_shadow',setBoxShadow.value); setdata('text_box_shadow',setTextBoxShadow.value); setdata('border_radius',setBorderRadius.value); setdata('gradient_fore',setGradFore.value); setdata('gradient_input',setGradInput.value); setdata('gradient_button',setGradButton.value); setdata('magnitude',setMagnitude.value); setdata('specimen',encodeURIComponent(setSpecimen.value)); setdata('background',setBackImage.value);" src="<?=$prefix[3].'return.png';?>" title="<?=term('Apply Settings',$settings['vocabulary'],$session['units']);?>">
