...
<div class='customPanel' id='prefs_btns' style="width:100%;height:40px;left:0px;top:0px;">
    <p align='center'>
        <input type='image' id='prefsBtnApply' onmouseover="soundButton();" class="power" onclick="setdata('box_shadow',setBoxShadow.value); setdata('text_box_shadow',setTextBoxShadow.value); setdata('radius',setBorderRadius.value); setdata('gradient_fore',setGradFore.value); setdata('gradient_input',setGradInput.value); setdata('gradient_button',setGradButton.value); setdata('magnitude',setMagnitude.value); setdata('specimen',encodeURIComponent(setSpecimen.value)); setdata('background',setBackImage.value);" src="<?=$prefix[3].'return.png';?>" title="<?=term('Apply Settings',$settings['vocabulary'],$session['units']);?>">
        ...
        <input type='image' id='prefsBtnUpdate' onmouseover="soundButton();" class="power" onclick="rename_user(sysDefSessionID.value,setUsername.value,setPassword.value); omniAuthRequest('signin',setUsername.value, CryptoJS.SHA256(setPassword.value).toString());" src="<?=$prefix[3].'lock.png';?>" title="<?=term('Update Password',$settings['vocabulary'],$session['units']);?>">
...
<div class='customPanel' id='prefs_tab' style="width:100%;height:70%;left:0px;top:0px;overflow-y:scroll;">
    <p align='center'>
        ...
        <input type="text" id="setTextBoxShadow" style="width:38%;" value="<?=$session['text_box_shadow'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setTextShadow" style="width:38%;" value="<?=$session['text_shadow'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setGradButton" style="width:12%;" value="<?=$session['gradient_button'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setBorderRadius" style="width:12%;" value="<?=$session['radius'];?>" onkeydown="if (event.keyCode==13) {
        ...
        <input type="text" id="setBackSize" style="width:12%;" value="<?=$session['back_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setForeSize" style="width:12%;" value="<?=$session['fore_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setInputSize" style="width:12%;" value="<?=$session['input_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="number" min='0' max='9' step='1' id="setMagnitude" style="width:12%;" value="<?=$session['magnitude'];?>" oninput="setdata('magnitude',setMagnitude.value); handleInput(this.value,true);" onkeydown="if (event.keyCode==27) { this.value=5;
        } else if (event.keyCode==8) {
            handleInput(this.value);
        } else if (event.keyCode==46) {
            handleInput(this.value);
        }"><br>
        <input type="text" id="setGradFore" style="width:12%;" value="<?=$session['gradient_fore'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setGradInput" style="width:12%;" value="<?=$session['gradient_input'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setHead2Size" style="width:12%;" value="<?=$session['head2_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setHead3Size" style="width:12%;" value="<?=$session['head3_size'];?>" onkeydown="
        if (event.keyCode==13) {
        ...
        <input type="text" id="setDispSize" style="width:12%;" value="<?=$session['disp_size'];?>" onkeydown="
        if (event.keyCode==13) {
