...
<div class='customPanel' id='prefs_btns' style="width:100%;height:40px;left:0px;top:0px;">
    <p align='center'>
        ...
        <input type='image' id='prefsBtnUpdate' onmouseover="soundButton();" class="power" onclick="rename_user(sysDefSessionID.value,setUsername.value,setPassword.value); omniAuthRequest('signin',setUsername.value, CryptoJS.SHA256(setPassword.value).toString());" src="<?=$prefix.'lock.png';?>" title="<?=term('Update Password',$settings['vocabulary'],$session['units']);?>">
