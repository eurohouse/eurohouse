...
<p align='center'>
<input type="button" onmouseover="soundButton();" onclick="setdata('box_shadow', setBoxShadow.value); setdata('text_box_shadow', setTextBoxShadow.value); setdata('radius', setBorderRadius.value); setdata('back_size', setBackSize.value); setdata('fore_size', setForeSize.value); setdata('input_size', setInputSize.value); setdata('magnitude', setMagnitude.value); setdata('gradient_deg', setGradDeg.value); setdata('head1_size', setHead1Size.value); setdata('head2_size', setHead2Size.value); setdata('head3_size', setHead3Size.value); setdata('disp_size', setDispSize.value); setdata('back_color', setBackColor.value); setdata('fore_color', setForeColor.value); setdata('input_color', setInputColor.value); setdata('back_text_color', setBackTextColor.value); setdata('fore_text_color', setForeTextColor.value); setdata('input_text_color', setInputTextColor.value); setdata('blank_color', setBlankColor.value); setdata('blank_text_color', setBlankTextColor.value); setdata('arc_fore_color', setArcForeColor.value); setdata('arc_input_color', setArcInputColor.value); setdata('specimen', encodeURIComponent(setSpecimen.value));" value="<?=term('Apply', $settings['vocabulary'], $session['units']);?>">
...
<input type="button" onmouseover="soundButton();" onclick="setSpecimen.value = 'Q F S H Æ Ø Ð Ñ ʒ ʊ ʎ ɸ Σ Φ Ω Θ Г З Х Б ظ ض ؤ ل 인 방 학 적 中 京 日 木 𐎁 𐎛 𐎍 𐎄 🍷 ☕️ 🍾 🍫'; setdata('specimen', setSpecimen.value);" value="<?=term('Reset', $settings['vocabulary'], $session['units']);?>">
