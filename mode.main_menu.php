            ...
            <div class='grid-item'>
                <div class='grid-label'>
                    <a href="<?=$eurArrPkg['run'];?>">
                        <?=titlePkgEnt($value,'title',$settings,$session);?>
                    </a>
                </div>
                <div class='grid-icon'>
                    <img onmouseover="soundButton();" loading="lazy" name="<?=$eurArrPkg['run'];?>" style="height:20%;" onclick="soundClick(); window.location.href=this.name;" src="<?=$eurArrFavicon;?>" title="<?=titlePkgEnt($value,'title',$settings,$session);?>">
                </div>
            </div><?php }} ?>
        </div>
    ...
    <?php } else {
        foreach ($index as $key=>$value) {
            ...
            foreach ($appIndex as $key=>$value) {
                ...
                $eurArrPkg=fileopen($value); ?>
                <p align='center'>
                    <input type="button" class="button" name="<?=$eurArrPkg['run'];?>" onmouseover="soundButton();" style="width:80%;" value="<?=titlePkgEnt($value,'title',$settings,$session);?>" onclick="soundClick(); window.location.href=this.name;">
                </p>
            <?php }
        }
    }
