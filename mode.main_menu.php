...
<p align="center">
    <img onmouseover="soundButton();" id="showingBardotLNow" name="brigitte_bardot" style="height:54%;" onclick="omniGo(this.name);" src="<?=$portfolioPrefix.'left0.png'.$suffix;?>">
    <img onmouseover="soundButton();" id="showingBardotNow" name="" style="height:54%;" onclick="omniGo(this.name);" src="<?=$portfolioPrefix.'head.png'.$suffix;?>">
