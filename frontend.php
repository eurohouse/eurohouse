...
function userdata() {
    var obj = {
        ...
        'cursor_auto': sysDefCursorAuto.value,
        'cursor_default': sysDefCursorDefault.value,
        'cursor_none': sysDefCursorNone.value,
        'cursor_context_menu': sysDefCursorContextMenu.value,
        'cursor_help': sysDefCursorHelp.value,
        'cursor_pointer': sysDefCursorPointer.value,
        'cursor_progress': sysDefCursorProgress.value,
        'cursor_wait': sysDefCursorWait.value,
        'cursor_cell': sysDefCursorCell.value,
        'cursor_crosshair': sysDefCursorCrosshair.value,
        'cursor_text': sysDefCursorText.value,
        'cursor_vertical_text': sysDefCursorVerticalText.value,
        'cursor_alias': sysDefCursorAlias.value,
        'cursor_copy': sysDefCursorCopy.value,
        'cursor_move': sysDefCursorMove.value,
        'cursor_no_drop': sysDefCursorNoDrop.value,
        'cursor_not_allowed': sysDefCursorNotAllowed.value,
        'cursor_all_scroll': sysDefCursorAllScroll.value,
        'cursor_col_resize': sysDefCursorColResize.value,
        'cursor_row_resize': sysDefCursorRowResize.value,
        'cursor_n_resize': sysDefCursorNResize.value,
        'cursor_s_resize': sysDefCursorSResize.value,
        'cursor_e_resize': sysDefCursorEResize.value,
        'cursor_w_resize': sysDefCursorWResize.value,
        'cursor_ns_resize': sysDefCursorNSResize.value,
        'cursor_ew_resize': sysDefCursorEWResize.value,
        'cursor_ne_resize': sysDefCursorNEResize.value,
        'cursor_nw_resize': sysDefCursorNWResize.value,
        'cursor_se_resize': sysDefCursorSEResize.value,
        'cursor_sw_resize': sysDefCursorSWResize.value,
        'cursor_nesw_resize': sysDefCursorNESWResize.value,
        'cursor_nwse_resize': sysDefCursorNWSEResize.value,
        'cursor_zoom_in': sysDefCursorZoomIn.value,
        'cursor_zoom_out': sysDefCursorZoomOut.value,
...
function world_clock() {
    $.ajax({
        ...
        success: function(data) {
            ...
            } $('#buttonFaceoff').attr('src', sysDefPrefix.value+'image.png'+sysDefSuffix.value); if (tickPanel.split('')[3] == 1) {
