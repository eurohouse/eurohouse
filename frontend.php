...
function administer(sta,act,fn) {
    if (superuser()) {
        var obj=document.getElementById('sysDef'+ucfirst(sta)+'Data');
        arr=(obj!==null)?obj.value:';', sb=arr.slice(0,-1), ob=arrjob(sb,';',':'), sum=arrsum(Object.values(ob)), qua=Object.keys(ob).length; if ((sta=='bind')||(sta=='call')) {
