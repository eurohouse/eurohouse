...
class RecycleBin {
    move(name) {
        var itd=(superuser())?'rw':sysDefSessionID.value; data(sysDefSessionID.value+'_files/recycle_bin.json','put',name,'',itd,'re');
    }
    restore(name) {
        var itd=(superuser())?'rw':sysDefSessionID.value; data(sysDefSessionID.value+'_files/recycle_bin.json','unput',name,'',itd,'re');
    }
    destroy(name) {
        var itd=(superuser())?'rw':sysDefSessionID.value; data(sysDefSessionID.value+'_files/recycle_bin.json','drop',name,'',itd,'re');
    }
    clear() {
        var itd=(superuser())?'rw':sysDefSessionID.value; data(sysDefSessionID.value+'_files/recycle_bin.json','clear','','',itd,'re');
    }
