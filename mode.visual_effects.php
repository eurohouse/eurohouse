...
<div class="customPanel" style="width:100%;-webkit-columns:2;-moz-columns:2;columns:2;">
    <p align='center'>
        <?=term('Opacity',$settings['vocabulary'],$session['units']);?> 
    ...
    <p align='center'> 
        <?=term('Blur',$settings['vocabulary'],$session['units']);?> 
    ...
    <p align='center'>
        <?=term('Saturate',$settings['vocabulary'],$session['units']);?> 
    ...
    <p align='center'>
        <?=term('Contrast',$settings['vocabulary'],$session['units']);?> 
    ...
    <p align='center'>
        <?=term('Sepia',$settings['vocabulary'],$session['units']);?> 
    ...
    <p align='center'>
        <?=term('Grayscale',$settings['vocabulary'],$session['units']);?> 
    ...
    <p align='center'>
        <?=term('Hue',$settings['vocabulary'],$session['units']);?> 
