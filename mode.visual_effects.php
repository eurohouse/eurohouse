...
<div style="width:100%;position:relative;">
    <p align='center'><?=term('Opacity', $settings['vocabulary'], $session['units']);?> 
...
<div style="width:100%;position:relative;">
    <p align='center'><?=term('Bright', $settings['vocabulary'], $session['units']);?> 
...
<div style="width:100%;position:relative;">
    <p align='center'><?=term('Contrast', $settings['vocabulary'], $session['units']);?> 
...
<div style="width:100%;position:relative;">
    <p align='center'><?=term('Grayscale', $settings['vocabulary'], $session['units']);?> 
