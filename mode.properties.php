...
if ($request['lock']!='false') {
    ...
    <p align='center' class='block'>
        ...
        <input type="image" onmouseover="soundButton();" class="power" id="buttonSave" onclick="soundClick(); data(objDataFile.value,'add',objDataPath.value,objDataValue.value,((superuser())?'rw':sysDefSessionID.value),'r');" src="<?=$prefix[3].'save.png';?>"><br>
