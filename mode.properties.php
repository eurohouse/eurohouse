<!-- info -->
<!-- AD: Propiedades; AG: Propiedades; AR: Propiedades; AT: Objekteigenschaften; BE: Propriétés; BR: Propriedades; CH: Notitias Objectum; CL: Propiedades; CN: 文件信息和属性; CO: Propiedades; CU: Propiedades; CY: Ταξινόμηση; DD: Objekteigenschaften; DE: Objekteigenschaften; DR: Objekteigenschaften; ES: Propiedades; FR: Propriétés; GR: Ταξινόμηση; IN: वस्तु गुण; IT: Proprietà; JP: ファイル情報; KP: 파일정보; KR: 파일정보; LK: वस्तुगुणाः; MC: Propriétés; MD: Proprietățile; MX: Propiedades; NP: དངོས་པོའི་ཁྱད་ཆོས།; PT: Propriedades; RO: Proprietățile; RS: Својства објекта; RU: Свойства; SM: Proprietà; SP: Notitias Objectum; TR: Nesne özellikleri; UA: Властивості об'єкту; VA: Notitias Objectum -->
<!-- <ref> -->
<!-- true -->
<?php
