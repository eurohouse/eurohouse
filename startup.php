...
function databox() {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#sysDefToolData').val(pager(data,4));
            $('#sysDefCallData').val(pager(data,5));
            $('#sysDefLockData').val(pager(data,6));
            $('#sysDefCodexBox').val(pager(data,7).split("\\\\")[0]);
            $('#sysDefSpeechBox').val(pager(data,7).split("\\\\")[1]);
            $('#sysDefUsersList').val(pager(data,8));
            $('#sysDefHoursNow').val(pager(data,9));
            $('#sysDefHoursActive').val(pager(data,10));
            $('#sysDefAvatarsNow').val(pager(data,11));
            $('#sysDefMetaData').val(pager(data,12));
            $('#sysDefTutorData').val(pager(data,13));
            $('#sysDefNewsData').val(pager(data,14));
            $('#sysDefIpData').val(pager(data,15));
            $('#sysDefHdiData').val(pager(data,16));
            $('#sysDefModelData').val(pager(data,17));
            $('#sysDefContentData').val(pager(data,18));
...
function world_clock() {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#sysDefDataLoad').val(pager(data,7));
            ...
            var calls=strarr(sysDefCallData.value,';',':');
            if (enzi[1].split('')[1]!=0) {
...
function automator() {
    ...
    var callPower=strarr(sysDefBindData.value,';',':');
