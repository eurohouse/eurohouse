...
window.onload=function() {
    if (window.history.replaceState) {
        ...
        omniListen(utob(sysDefMelody.value));
...
function world_clock() {
    $.ajax({
        ...
        success: function(data) {
            ...
            showUsCurrentMusic.innerText=utob(sysDefMelody.value);
            ...
            $('#sysDefMyVisitorsData').val(pager(data,6));
            $('#usernameBanner').val(sysDefSessionID.value); if (authstate()) {
                sysDefMsgMaxCount.value=parseInt(Object.keys(filterMessages(sysDefMyMessengerData.value)).length-1);
                ...
                sysDefMsgCurrent.value=Object.values(filterMessages(sysDefMyMessengerData.value))[sysDefMsgCounter.value];
            ...
            $('#buttonSlideshow').attr('src',sysDefPrefix.value+((sysDefSlideshow.value!=0)?'speed.png':'time.png'));
