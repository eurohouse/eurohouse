...
function world_clock() {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#alarmTime').val((pager(data,2)!='00:00')?pager(data,2):((sysDefPlayBackwards.value!=0)?hhmmss((sysDefDuration.value-sysDefCurrent.value),true):hhmmss(sysDefCurrent.value,true)));
