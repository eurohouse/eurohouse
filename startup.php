        ...
        success: function(data) {
            ...
            if (requestMode.value == 'bookkeeping') {
                ...
                var albCol=((sysDefAlbum.value=='avatar')||(sysDefAlbum.value=='pictogram'))?1:sysDefAlbumColumns.value; if (sysDefAlbum.value=='music') {
                    for (iu in alb) {
                        arl+="<a href='javascript:omniListen(%22"+rfc3986(alb[iu])+"%22,true);' onmousedown='setTimeout(function() { setdata(%22playlist%22,playlistNext(%22"+rfc3986(alb[iu])+"%22)); }, 1000);'>"+(parseInt(iu)+1)+'. '+alb[iu]+"</a><br>";
                    }
