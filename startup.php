...
function world_clock() {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#buttonLogin').attr('src',sysDefPrefix.value+'login.png');
            $('#buttonRegister').attr('src',sysDefPrefix.value+'mkdir.png');
            ...
            if (requestMode.value == 'bookkeeping') {
                ...
                var alb=lockarr(sysDefAlbum.value),arl='<ol id="albumCollection">',col=sysDefAlbumColumns.value;
                for (iu in alb) {
