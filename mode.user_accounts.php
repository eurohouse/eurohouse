...
<table style="width:100%;" id="table"><thead><tr>
    <th style="width:16%;<?=$preStyle;?>"><a href="javascript:SortTable(0, 'T');"><?=term('Name', $settings['vocabulary'], $session['units']);?></a></th><th style="width:12%;<?=$preStyle;?>">
    <a href="javascript:SortTable(1, 'T');"><?=term('Username', $settings['vocabulary'], $session['units']);?></a></th>
    <th style="width:5%;"><?=term('Actions', $settings['vocabulary'], $session['units']);?></th></tr></thead>
    <tbody><?php foreach ($relBind as $key=>$value) {
        ...
        <tr><td><?=$cookieLeft['title'];?></td>
        <td><?=$value;?></td><td><p align='center' class='block'>
