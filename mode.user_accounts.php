    ...
    <tr>
        ...
        <p align='center' class='block'>
            ...
            <?php if (isAuthorized()) {
                ...
                <?php } else {
                    if ($value==$sessionID) { ?>
                        <input type="image" name="<?=$value;?>" onmouseover="soundButton();" class="power" onclick="setfor(sysDefSessionID.value,sysDefPowersData,'dominion',-666);" src="<?=$prefix[3].'trash.png';?>">
                    <?php } else { ?>
