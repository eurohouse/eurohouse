...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>
            <?=$session['title'].' (@'.$sessionID.') · Eurohouse UX/UI';?>
        </title>
        <link rel="shortcut icon" href="favicon.png" type="image/x-icon">
        <?php
        include 'wardrobe.php';
    ...
    <div class='overlay'>
        ...
        <div class='upperGap'>
            <span id='showUsUrgent' onclick="navigator.clipboard.writeText(this.value);"></span>
        ...
        <div class='lowerGap'>
            <span class="marquee" id='showUsText' onclick="navigator.clipboard.writeText(this.value);"></span>
        </div>
