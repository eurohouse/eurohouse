...
<div class='topBarItem'><p align='center' class='block'>
    ...
    <input type="image" onmouseover="soundButton();" id="buttonTime" class="power" onclick="setdata('benchmark', nextImage('0;1;2;3;4', sysDefBenchmark.value));" src="<?=$prefix.'time.png'.$suffix;?>">
...
<div class='topBarItem'><p align='center' class='block'>
    <input type="image" id="userAvatarBadge" onmouseover="soundButton();" class="power" src="<?=$abcPrefix.$session['avatar'].'.png'.$suffix;?>">
