...
<body>
    <div class='overlay'>
        ...
        <input type='hidden' id="sysDefMyVisitorsData" value="<?=json_encode($visitors,JSON_UNESCAPED_UNICODE);?>">
        ...
        <div class='upperGap'>
            <span class="marquee" id='showUsCurrentMusic' class="urgent" onclick="soundClick(true); clip(this.innerText);">
                <?=base64_decode($session['melody']);?>
            </span><br>
        ...
        <div class='lowerGap'>
            <span class="marquee" id='showUsText' onclick="soundClick(true); clip(this.innerText);"></span>
        </div>
