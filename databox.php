...
$musicBox = excpkg($musicBoxArr, $locksArr['music']); $soundBox = excpkg($soundBoxArr, $locksArr['sound']);
natcasesort($musicBox); array_unique($musicBox); natcasesort($soundBox); array_unique($soundBox);
