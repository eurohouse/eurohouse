...
foreach ($index as $key=>$value) {
    ...
    <?php
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['movie']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['sound']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['video']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['midi']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['font']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['data']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['script']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['book']))) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['archive']))) {
        ...
        <?php
        } elseif (($mediaFileExtension == 'lnk') || ($mediaFileExtension == 'url')) {
        ...
        <?php
        } elseif (in_array($mediaFileExtension, duplex($settings['collections']['image']))) {
...
<tfoot>
    <tr>
        <th style="width:9%;"></th>
        <th style="width:20%;"><?=$searchFilesCount;?></th>
