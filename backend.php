...
} $avaPrefix=(isColorLight($session['back_text_color']))?'ava.':'abc.';
$abcPrefix=(isColorLight($session['fore_text_color']))?'ava.':'abc.';
$prefix=(isColorLight($session['fore_text_color']))?'iso.':'iec.';
$reticlePrefix=(isColorLight($session['fore_text_color']))?'rtd.':'rtc.';
