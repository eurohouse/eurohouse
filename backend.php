...
$lockMusic = excpkg($musicBox, $locks['music']); $lockSounds = excpkg($orpheus, $locks['sound']);
natcasesort($lockMusic); array_unique($lockMusic); natcasesort($lockSounds); array_unique($lockSounds);
