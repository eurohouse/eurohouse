...
$metadata=fileopen($sessionID.'_files/metadata.json',json_encode($settings['metadata']),'create backup restore');
...
$usersList=str_replace('_files','',str_replace('./','',(glob('./*_files',GLOB_ONLYDIR)))); natcasesort($usersList); deleteMarkedUsers();
$visitors=visitor($sessionID,true);