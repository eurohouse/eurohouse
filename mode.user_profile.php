...
<div class='customPanel' style="width:100%;">
    <p align="center">
        <img onmouseover="soundButton();" id="showUserAvatar" name="main_menu" style="height:24%;" onclick="omniGo(this.name);" src="<?=$prefix[0].$session['avatar'].'.png';?>">
        <h1 id="showUserHead" align='center' style="cursor:pointer;" onclick="clip(this.innerText);"></h1>
    </p>
</div>
<div class='customPanel' style="width:100%;height:50%;overflow-y:scroll;">
    <p id="showUserBody" align="center" style="cursot:pointer;" onclick="clip(this.innerText);"></p>
</div>
