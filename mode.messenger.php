...
<p align='center' class='block'>
    ...
    } else if (event.keyCode==27) { composeMessage.value=''; composeMessage.focus();
    ...
    <input type="image" class="power" id="buttonBackspace" onmouseover="soundButton();" src="<?=$prefix[3].'backspace.png';?>" onclick="soundClick(); composeMessage.value=''; composeMessage.focus();">
</p>
</div>
