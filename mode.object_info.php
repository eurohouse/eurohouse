<!-- info -->
<!-- GR: Ιδιότητες αντικειμένου; DE: Objekteigenschaften; CY: Ιδιότητες αντικειμένου; FR: Propriétés de l'objet; IT: Proprietà dell'oggetto; RU: Свойства объекта; LK: वस्तुगुणाः; IN: वस्तु गुण; ES: Propiedades del objeto; MX: Propiedades del objeto; PT: Propriedades do objeto; BR: Propriedades do objeto; RO: Proprietățile obiectului; MD: Proprietățile obiectului; NP: དངོས་པོའི་ཁྱད་ཆོས།; RS: Својства објекта; UA: Властивості об'єкту; TR: Nesne özellikleri; CN: 文件信息和属性; KR: 파일정보; JP: ファイル情報; AE: خصائص الملف -->
<!-- <ref> -->
<!-- true -->
